...
<body>
	...
	String rollno = (String)session.getAttribute("rollno");
		...
		<% }%>
	<%
		String old_rollno = (String)session.getAttribute("rollno");
	try {
    ...
    <div class="content-container">
        <div class="book-data-input">
            <div class="book-data-box">
                ...
                <input type="number" name="rollno" placeholder="Rollno" value="<%= rs.getString("rollno") %>" readonly required>
                </div>
                <div class="book-data-field">
                ...
                <input type="radio" class="-ml-20" id="UG" name="degree" value="UG">
                <label for="PG">PG</label>
                <input type="radio" id="PG" class="-ml-20" name="degree" value="PG">
                </div>
                </div>
                <div class="book-data-field">
